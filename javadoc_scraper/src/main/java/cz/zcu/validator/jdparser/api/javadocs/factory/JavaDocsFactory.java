...
public class JavaDocsFactory {
     ...
     */
    public JavaDocClass makeJavaDocClass(String name, String text, String deprecated, String since, String see, String author, String version, String keywords) {
        ...
        return new JavaDocClass(name, text, !deprecated.isEmpty(), since, Arrays.asList(seeArray), Arrays.asList(authorArray), version, keywords);
    }
