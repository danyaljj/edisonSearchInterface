...
public class JavaDocClass extends AbstractJavaDoc implements Authorable, Versionable {
	...
	public JavaDocClass(String name, String textComment, boolean deprecated, String since, Collection<String> see, Collection<String> authors, String version, String keywords) {
